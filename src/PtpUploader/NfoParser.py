...
class NfoParser:
    ...
    def __IsUsefulLine(line):
        ...
        # If the line doesn't contain spaces or a periods than it most likely doesn't contain any text,
        # just drawing by text. (See an NFO of a Japhson release for example.)
