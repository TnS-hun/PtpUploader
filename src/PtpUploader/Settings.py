...
class Settings(object):
    ...
    def MakeListFromExtensionString(extensions):
        ...
        # If extensions is empty then we need an empty list.
    ...
    def LoadSettings():
        ...
        Settings.WebServerSslCertificatePath = Settings.__GetDefault(configParser, "Settings",
                                                                     "WebServerSslCertificatePath", "")
        Settings.WebServerSslPrivateKeyPath = Settings.__GetDefault(configParser, "Settings",
                                                                    "WebServerSslPrivateKeyPath", "")
        Settings.WebServerFileTreeInitRoot = Settings.__GetDefault(configParser, "Settings",
                                                                   "WebServerFileTreeInitRoot", u"~")
