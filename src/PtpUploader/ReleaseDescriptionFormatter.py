...
class ReleaseDescriptionFormatter:
    ...
    def __GetMediaInfoHandleNonDvdImage(self):
        ...
        mediaInfos = MediaInfo.ReadAndParseMediaInfos(self.ReleaseInfo.Logger, self.VideoFiles,
    ...
    def __TakeAndUploadScreenshotsForEntry(self, screenshotList, videoEntry):
        ...
        if screenshots is None:
            screenshots = screenshotMaker.TakeAndUploadScreenshots(self.OutputImageDirectory,
