...
class IncludedFileItem:
    ...
    def __GetDefaultState(self):
        ...
        if path.startswith("proof/") or path.startswith("sample/") or path.startswith("!sample/") or path.startswith(
                "samples/") or path.startswith("extra/") or path.startswith("extras/"):
