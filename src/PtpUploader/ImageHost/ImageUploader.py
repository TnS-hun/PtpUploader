...
class ImageUploader:
    ...
    def Upload(logger, imagePath=None, imageUrl=None):
        ...
        # TODO: fall back to secondary host if the upload to ptpimg wasn't successful.
        # Also start a 1 hour countdown and doesn't use ptpimg till it gets to 0.
        ...
        raise PtpUploaderException("Unknown image host: '%ds'." % Settings.ImageHost)