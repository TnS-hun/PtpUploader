...
# "While it might be tempting to create Logger instances on a per-connection basis, this is not a good idea because
# these instances are not garbage collected."
