...
class ReleaseInfoMaker:
    ...
    def CollectVideoFiles(self):
        ...
        if os.path.isdir(self.Path):
            # Make sure that path doesn't ends with a trailing slash or
            # else os.path.split would return with wrong values.
    ...
    def SaveReleaseDescripionFile(self, logger, releaseDescriptionFilePath, createScreens):
        ...
        releaseDescriptionFormatter = ReleaseDescriptionFormatter(releaseInfo, self.VideoFiles, self.AdditionalFiles,
