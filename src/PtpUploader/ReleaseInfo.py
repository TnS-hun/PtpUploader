...
class ReleaseInfoFlags:
    ...
    # If this is set then the job will be the next processed job and the download will start regardless the number of
    # maximum parallel downloads set for the source.
...
class ReleaseInfo(Database.Base):
    ...
    def __init__(self):
        ...
        self.PtpId = ""
        self.PtpTorrentId = ""
        # International title of the movie. Eg.: The Secret in Their Eyes.
        # Needed for renaming releases coming from Cinemageddon.
        ...
        # This is the final path where the torrent was created from.
        # It's either a directory or a file (for single file uploads).
        ...
        # The highest torrent ID from the group.
        # (Only filled out when the user presses says he wants to skip the duplicate checking.)
