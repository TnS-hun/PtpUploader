...
class MakeTorrent:
    ...
    def Make(logger, path, torrentPath):
        ...
        # Torrents with exactly the same content and piece size get the same info hash regardless of the
        # announcement URL.
        # To make sure that our new torrent will have unique info hash we add
        # a unused key to the info section of the metadata.
